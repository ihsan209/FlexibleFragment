package com.ihsannuraripin.flexiblefragment
...
class CategoryFragment : Fragment(),View.OnClickListener {
    ...
    override fun onClick(v: View?) {
        if (v?.id == R.id.btn_detail_category){
            ...
            val bundle = Bundle()
            bundle.putString(DetailCategoryFragment.EXTRA_NAME,"Lifestyle Ihsan")
            detailCategoryFragment.arguments = bundle

            val description = "Kategori ini berisi produk Life style"
